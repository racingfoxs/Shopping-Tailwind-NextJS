...
const Footer = () => {
  ...
  <div className="container px-5 py-24 mx-auto border-t-2">
  ...
  <div className="bg-gray-100">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-500 text-sm text-center sm:text-left">© 2022 SyntaxStyle —
        <a href="https://twitter.com/divyashwar" className="text-gray-600 ml-1" target="_blank" rel="noopener noreferrer">@divyashwar</a>
      </p>
