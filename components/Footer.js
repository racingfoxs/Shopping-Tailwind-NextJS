...
const Footer = () => {
  return (
    <footer className="px-4 divide-y bg-gray-100 text-gray-800 border-t-2 border-gray-200">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				<div className="flex items-center justify-center w-12 h-12 rounded-full bg-fuchsia-600">
				...
				<span className="self-center text-2xl font-semibold">Syntax Style</span>
			</a>
		</div>
